<template>
  <div v-if="format">
    <Splitter :layout="getLayout">
      ...
      <SplitterPanel class="right" :size="25">
        ...
        <template v-if="loaded">
          <Puzzle v-if="cardSvg" :puzzle-mode="puzzleMode" :reveal-level="revealLevel" :card-url="cardUrl" :card-svg="cardSvg" />
        </template>
        <template v-else>
  ...
  <div v-else class="format">
    ...
    <Listbox v-model="format" :options="formats" option-label="name" />
  </div>
